<div class="modal fade" id="add_element" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="elements/add_element.php" method="post">
        <div class="modal-body">
            ...
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="atomic_no" name="atomic_no" placeholder="atomic_no">
              <label for="floatingInput">Atomic Number</label>
            </div>
            <div class="form-floating mb-3">
              <input type="number" class="form-control" id="atomic_weight" name="atomic_weight" placeholder="atomic_weight">
